	...
	var base = {
		...
		init() {
			...
			function scrollEventHandler() {
				...
				if (mm.element.offset($anchor).top + _anchorHeight < $header.offsetHeight + mm.element.position($header).top - parseFloat(mm.element.style($anchor, 'padding-top')) && mm.element.offset(_.last($lists)).top + _.last($lists).offsetHeight > $btnDropdown.offsetHeight) {
